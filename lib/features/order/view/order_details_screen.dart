...
import 'package:ecommerce/basewidget/custom_image.dart';
import 'package:ecommerce/basewidget/image_diaglog.dart';
import 'package:ecommerce/features/dashboard/dashboard_screen.dart';
import 'package:ecommerce/features/home/shimmer/order_details_shimmer.dart';
import 'package:ecommerce/features/order/widget/cal_chat_widget.dart';
import 'package:ecommerce/features/order/widget/cancel_and_support_center.dart';
import 'package:ecommerce/features/order/widget/order_details_top_portion_widget.dart';
import 'package:ecommerce/features/order/widget/ordered_product_list.dart';
import 'package:ecommerce/features/order/widget/payment_info.dart';
import 'package:ecommerce/features/order/widget/seller_section.dart';
import 'package:ecommerce/features/order/widget/shipping_and_billing_widget.dart';
import 'package:ecommerce/features/order/widget/shipping_info.dart';
...
import 'package:ecommerce/basewidget/amount_widget.dart';
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        if(orderProvider.orderDetails != null && orderProvider.orderDetails!.isNotEmpty &&
                          ...
                          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            SizedBox(height: 120,
                              child: ListView.builder(itemCount: orderProvider.orderDetails![0].verificationImages?.length,
                                  scrollDirection: Axis.horizontal, itemBuilder: (context, index){
                                return InkWell(onTap: (){
                                  showDialog(context: context, builder: (_)=> ImageDialog(
                                      imageUrl: '${AppConstants.baseUrl}/storage/app/public/delivery-man/verification-image/'
                                    ...
                                    child: SizedBox(width: 200,
                                      child: ClipRRect(borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall),
                                        child: Container(decoration: BoxDecoration(
                                            ...
                                            child: CustomImage(image: '${AppConstants.baseUrl}/storage/app/public/delivery-man/verification-image/'
                                                '${orderProvider.orderDetails![0].verificationImages?[index].image}')),
                                      ))),
                                );
                              }))]),
