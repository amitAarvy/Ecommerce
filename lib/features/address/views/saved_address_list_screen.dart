...
import 'package:ecommerce/features/address/widgets/address_type_widget.dart';
            ...
            child: Column(children: [
              locationProvider.addressList!.isNotEmpty ?  ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return InkWell(onTap: () {Provider.of<CheckOutProvider>(context, listen: false).setAddressIndex(index);
                    ...
                    child: Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault),
                      child: Container(margin: const EdgeInsets.only(top: Dimensions.paddingSizeSmall),
                        decoration: BoxDecoration(
                          ...
                          border: index == Provider.of<CheckOutProvider>(context).addressIndex ? Border.all(width: 2, color: Theme.of(context).primaryColor) : null,
                        ),
                        child: AddressListPage(address: locationProvider.addressList?[index]))));
                },
              ):
